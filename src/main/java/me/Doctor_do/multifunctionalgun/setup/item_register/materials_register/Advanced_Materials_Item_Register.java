...
public final class Advanced_Materials_Item_Register {
    ...
    public static void Advanced_Materials_Item_Register_Setup() {

        AdvancedMaterials_ItemType_Item(
        ...
        AdvancedMaterials_ItemType_Item(
                ...
                new ItemStack[]{
                        ...
                        Basic_Materials.REGULATOR, SlimefunItems.MULTIMETER, Basic_Materials.GENERIC_INTERFACE
                }
        );
        ...
        AdvancedMaterials_ItemType_Item(
                ...
                new ItemStack[]{
                        ...
                        Basic_Materials.REGULATOR, SlimefunItems.ANDROID_MEMORY_CORE, Basic_Materials.GENERIC_INTERFACE,
        ...
        AdvancedMaterials_ItemType_Item(
                ...
                new ItemStack[]{
                        Basic_Materials.GENERIC_INTERFACE, new ItemStack(Material.OBSERVER), Basic_Materials.GENERIC_INTERFACE,
                        Basic_Materials.GENERIC_INTERFACE, SlimefunItems.ANDROID_MEMORY_CORE, Basic_Materials.REGULATOR,
                        Basic_Materials.GENERIC_INTERFACE, Basic_Materials.GENERIC_INTERFACE, Basic_Materials.GENERIC_INTERFACE
                }
        );
        ...
        AdvancedMaterials_ItemType_Item(
                ...
                new ItemStack[]{
                        ...
                        Basic_Materials.VOLTAGE_REGULATOR_DIODE_CIRCUIT, SlimefunItems.ADVANCED_CIRCUIT_BOARD, Basic_Materials.GENERIC_INTERFACE
                }
        );
    ...
    public static void AdvancedMaterials_ItemType_Item(SlimefunItemStack item, ItemStack[] itemStack) {
        new ItemType_Item(

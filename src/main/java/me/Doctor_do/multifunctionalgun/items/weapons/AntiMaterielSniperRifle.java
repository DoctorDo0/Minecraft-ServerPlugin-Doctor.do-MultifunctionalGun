...
public class AntiMaterielSniperRifle extends SlimefunItem implements NotPlaceable {
    public static final Integer damage_temp = 75;
    ...
    public void CauseDamageToEntity(PlayerInteractEvent event, Integer damage) {
        event.getPlayer().sendMessage(ChatColors.color("&7测试:&fGun:&fAntiMaterielSniperRifle:&fDamage" + damage));
        getLogger().info("&7测试:&fGun:&fAntiMaterielSniperRifle:&fDamage" + damage);
    }
}

...
import static me.Doctor_do.multifunctionalgun.setup.slimefun_items_setup.Gun_And_Bullet_Item_Setup.AssaultRifle;

public class RifleBullet extends ItemType_Bullet {
    public static final ItemType_Gun gun = (ItemType_Gun) AssaultRifle;
    public static final double multiplier = 1.0;
    public static final String options = "none";
    public static final int keepTime = 0;

    public RifleBullet(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, ItemStack recipeOutput) {

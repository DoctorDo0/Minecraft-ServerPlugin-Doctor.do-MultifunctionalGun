...
public class Scope extends SlimefunItem implements NotPlaceable {
    ...
    private void onItemUseRightClick(PlayerRightClickEvent event) {
        ...
        event.cancel();
        ScopeUseEvent(event.getInteractEvent());
    }

    public void ScopeUseEvent(PlayerInteractEvent event) {
        event.getPlayer().sendMessage(ChatColors.color("&7测试:&fGun:&fScope"));
